...
fun BottomNavBar(
    ...
    val items = listOf(
        ...
        BottomNavItem(Screen.Catalog,   "Catálogo",  Icons.Outlined.DirectionsBus,   Icons.Filled.DirectionsBus),
        BottomNavItem(Screen.Reservations, "Reservas", Icons.Outlined.BookOnline,    Icons.Filled.BookOnline, cartCount),
        BottomNavItem(Screen.MyTrips,   "Viajes",    Icons.Outlined.Route,           Icons.Filled.Route),
    ...
    NavigationBar(
        ...
        items.forEach { item ->
            ...
            NavigationBarItem(
                selected = isSelected,
                onClick  = {
                    if (item.screen == Screen.Reservations) {
                        onReservationsClick()
                    } else {
