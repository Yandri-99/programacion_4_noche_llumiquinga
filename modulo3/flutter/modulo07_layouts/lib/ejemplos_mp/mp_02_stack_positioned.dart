...
/// mp_ejercicio2 - Stack + Positioned: Tarjeta de Vehículo con Badge de Estado
    ...
    return Card(
      ...
      child: Stack(
        children: [
          ...
          // Badge de estado - positioned arriba a la derecha
          Positioned(
            top: 8,
            right: 8,
            child: Container(
...
class ListaVehiculosStack extends StatelessWidget {
  const ListaVehiculosStack({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Vehículos - Stack Layout')),
      body: ListView(
        children: const [
...
void main() => runApp(const MaterialApp(home: ListaVehiculosStack()));
