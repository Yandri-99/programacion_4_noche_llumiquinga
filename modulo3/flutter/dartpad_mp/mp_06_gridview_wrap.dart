...
/// [DartPad] mp_06_gridview_wrap.dart
/// GridView + Wrap: Flota de Vehiculos en Grid
...
final List<VehiculoGrid> vehiculos = [
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Text(
                            ...
                            style: TextStyle(fontSize: 11, color: v.activo ? Colors.green[700] : Colors.red[700], fontWeight: FontWeight.w600),
                          ),
                        ),
                      ],
                    ),
