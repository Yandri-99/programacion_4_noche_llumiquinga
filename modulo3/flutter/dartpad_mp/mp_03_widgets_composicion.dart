...
/// [DartPad] mp_03_widgets_composicion.dart
/// StatelessWidget + StatefulWidget: Catálogo de Vehículos
...
class _CatalogoVehiculosState extends State<CatalogoVehiculos> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Catalogo de Vehiculos')),
      body: Column(
        children: [
          Padding(
            padding: const EdgeInsets.all(16),
            child: Text(
              '$activos de ${_vehiculos.length} vehiculos activos',
